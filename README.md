...
# 🛠 Technical Skills
 ...
 - **Frameworks / Libraries / Tools:** Git, React, Flask, TensorFlow, Keras, Scikit-learn, Pandas, Matplotlib

 - **AI / Developer Tools:** Claude Code, Devin, Codex, Cursor, Windsurf, Ollama Inference Server, LLM APIs (OpenAI, Gemini, etc.)

 - **Hardware / SDKs:** NeuroSky SDK, BrainFlow SDK, Arduino SDK, Google Apps Script 

 - **Databases:** MongoDB, Supabase, MySQL, PostgreSQL, SQLite 
